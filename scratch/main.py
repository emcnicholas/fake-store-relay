...
from scratch.func import get_products, get_categories, get_products_per_category, tile_def, get_time_utc_now, \
    get_time_period, fakestore_horizontal_bar_data, horizontal_bar_data, get_product_info, get_product_rating, \
    get_fakestore_donut_graph_data
...
if __name__ == '__main__':
    ...
    print(json.dumps(label_headers, indent=4))
